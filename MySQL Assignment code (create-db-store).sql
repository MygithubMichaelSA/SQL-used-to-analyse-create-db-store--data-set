...
CREATE TABLE `order_items` (
  `item_id` int(11) NOT NULL AUTO_INCREMENT,			-- New entity formed ('item_id').
  `order_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `quantity` int(11) NOT NULL,
  `unit_price` decimal(4,2) NOT NULL,
  PRIMARY KEY (`item_id`),								-- The new entity assigned as the primary key of this table.
  KEY `fk_order_items_orders_idx` (`order_id`),			-- The status of the 'order_id' entity was changed to foreign key.
  KEY `fk_order_items_products_idx` (`product_id`),
  CONSTRAINT `fk_order_items_orders` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_order_items_products` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
INSERT INTO `order_items` VALUES (1,1,4,4,3.74);  -- A new set of values (1-18) is added to each row, for the 'item_id' entity.
...
CREATE TABLE `order_item_notes` (			-- The name of this table being created is established as 'order_item_notes'.
  `note_id` int(11) NOT NULL AUTO_INCREMENT,	-- Data type specified to 'int(11)' to add consistency with rest of the code.
  `order_id` int(11) NOT NULL,					-- Data type specified to 'int(11)' to add consistency with rest of the code.
  `product_id` int(11) NOT NULL,				-- Data type specified to 'int(11)' to add consistency with rest of the code.
  `note` varchar(255) NOT NULL,
  PRIMARY KEY (`note_id`),
KEY `fk_order_items_notes_orders_idx` (`order_id`), 	-- The 'order_id' assigned as a foreign key in this table.
KEY `fk_order_items_notes_products_idx` (`product_id`), 	-- The 'product_id' assigned as a foreign key in this table.
...
-- The two constraints (above) confirm, from what table, the two foreign keys have come from. 
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
